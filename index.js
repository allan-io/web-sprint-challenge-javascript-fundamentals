...
// nested function can access the internal variable because of closure. external is in nestedFucntion lexical scope therefore if has access to the variable when the closure is created on nestedFunction invocation
...
function summation(num) {
  return num === 1 ? 1 : summation(num - 1) + num
  }
...
const zooAnimals = [
  ...
  */
  ...
  function USApop(arr){
    return arr.reduce((acc, curr) => acc + curr.population , 0)
  }
...
// console.log(greeting("allan", "oliveira"))
